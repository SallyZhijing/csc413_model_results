...
# Function to freeze all but top layers of T2T-ViT-14
def freeze_all_but_top_layers(model):
...
def initialize_model():
    ...
    model = freeze_all_but_top_layers(model)
...
# Save results to CSV
csv_filename = "training_results_t2t_vit_14.csv"
fieldnames = [
    'run', 'epoch',
...
plt.legend()
plt.grid(True)
plt.savefig('accuracy_plot_t2t_vit_14.png')
plt.show()

print("Accuracy plot saved as accuracy_plot_t2t_vit_14.png")
