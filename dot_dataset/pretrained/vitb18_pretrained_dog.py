...
for dataset_name in datasets_list:
    ...
    # Save the model
    model_path = f"best_model_vit_b_16_pretrained{True}_{dataset_name}.pth"
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(f'validation_loss_comparison_vit_b_16_pretrained{True}.png')
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(f'validation_accuracy_comparison_vit_b_16_pretrained{True}.png')
plt.show()
