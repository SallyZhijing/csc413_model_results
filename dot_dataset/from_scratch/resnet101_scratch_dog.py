...
for dataset_name in datasets_list:
    ...
    # Save the model
    model_path = f"best_model_resnet101_pretrained{False}_{dataset_name}.pth"
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(f'validation_loss_comparison_resnet101_pretrained{False}.png')
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(f'validation_accuracy_comparison_resnet101_pretrained{False}.png')
plt.show()
