...
for dataset_name in datasets_list:
    ...
    # Save the model
    model_path = f"best_model_vit_b_16_pretrained{False}_{dataset_name}.pth"
...
for dataset_name, loss_history in loss_results.items():
    plt.plot(range(len(loss_history)), loss_history, label=f'{dataset_name} Validation Loss')

plt.title('Validation Loss Comparison')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.savefig(f'validation_loss_comparison_vit_b_16_pretrained{False}.png')
plt.show()

# Plot validation accuracy comparison
plt.figure(figsize=(10, 5))
for dataset_name, acc_history in acc_results.items():
    plt.plot(range(len(acc_history)), acc_history, label=f'{dataset_name} Validation Accuracy')

plt.title('Validation Accuracy Comparison')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(f'validation_accuracy_comparison_vit_b_16_pretrained{False}.png')
plt.show()
